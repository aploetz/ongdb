...
import org.neo4j.cypher.internal.v3_6.ast.{CallClause, Create, CreateIndex, CreateNodeKeyConstraint, CreateNodePropertyExistenceConstraint, CreateRelationshipPropertyExistenceConstraint, CreateUnique, CreateUniquePropertyConstraint, Delete, DropIndex, DropNodePropertyExistenceConstraint, DropRelationshipPropertyExistenceConstraint, DropUniquePropertyConstraint, Foreach, Limit, LoadCSV, Match, Merge, OnCreate, OnMatch, OrderBy, Remove, Return, SetClause, Skip, Start, Statement, Union, Unwind, UpdateClause, Where, With}
