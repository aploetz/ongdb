...
import org.neo4j.cypher.internal.v3_6.ast.{Clause, Create, Query, SingleQuery, Start, UnaliasedReturnItem, Union, UnionAll, UnionDistinct}
...
object StatementConverters {
  ...
  def toUnionQuery(query: Query, semanticTable: SemanticTable): UnionQuery = {
    ...
    query match {
      ...
      case Query(periodicCommitHint, u: Union) =>
