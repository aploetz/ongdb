...
import org.neo4j.cypher.internal.v3_6.ast.{AliasedReturnItem, SortItem, UsingIndexHint, UsingJoinHint, UsingScanHint}
...
case class LogicalPlanProducer(cardinalityModel: CardinalityModel, planningAttributes: PlanningAttributes, idGen: IdGen) extends ListSupport {
  ...
  def planSort(inner: LogicalPlan, sortColumns: Seq[ColumnOrder], reportedSortItems: Seq[SortItem], interestingOrder: InterestingOrder, context: LogicalPlanningContext): LogicalPlan = {
