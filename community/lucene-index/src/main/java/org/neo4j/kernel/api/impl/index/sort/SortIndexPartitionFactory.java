 ...
 */
public class SortIndexPartitionFactory //implements IndexPartitionFactory
{
//    private Factory<IndexWriterConfig> writerConfigFactory;
//
//    public SortIndexPartitionFactory( Factory<IndexWriterConfig> writerConfigFactory )
//    {
...
//    {
//        return new SortIndexPartition( partitionFolder, directory, writerConfigFactory.newInstance() );
//    }
}
